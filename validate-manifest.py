...
def main():
    ...
    validate_schema_parser.add_argument("--manifest", default="specification-manifest.json", help="Path to the manifest")
    validate_schema_parser.add_argument("--schema", default="specification-manifest-schema.json", help="Path to the schema")
    ...
    validate_project_parser.add_argument("--manifest", default="specification-manifest.json", help="Path to the manifest")
