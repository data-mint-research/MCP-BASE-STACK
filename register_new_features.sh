...
python3 kg/scripts/register_feature.py --name "Documentation Structure" \
...
python3 kg/scripts/register_feature.py --name "Test Structure" \
...
python3 kg/scripts/update_feature.py --name "Documentation Structure" --status "completed"
python3 kg/scripts/update_feature.py --name "Test Structure" --status "completed"
