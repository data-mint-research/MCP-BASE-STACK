...
echo "The git-based backup functionality (create_backup_branch.sh) is now the only backup method."
echo "Use ./restore_from_backup.sh to restore from git-based backups."
