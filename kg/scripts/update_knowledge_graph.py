...
def update_knowledge_graph():
    ...
    component_checks = [
        ...
        ("librechat", "LibreChat/docker-compose.yml", "cloned"),
        ("librechat", "LibreChat/.env", "configured"),
        ("librechat", "LibreChat/librechat.yaml", "customized"),
        ("librechat", "librechat-status.txt", "deployed"),
        ("ollama", "ollama-status.txt", "deployed"),
        ("mistral", "mistral-model.txt", "loaded"),
        ("deepseek", "deepseek-model.txt", "loaded"),
        ("mcp_server", "mcp_server.py", "implemented"),
