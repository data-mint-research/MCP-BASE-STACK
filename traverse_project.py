...
def main():
    ...
    parser.add_argument(
        "--manifest", 
        default="specification-manifest.json", 
        help="Path to the specification manifest (default: specification-manifest.json)"
    )
    parser.add_argument(
        "--output", 
        default="project-structure-report.json", 
        help="Path to save the report to (default: project-structure-report.json)"
    )
    parser.add_argument(
        "--verbose", 
        action="store_true", 
